...
PLATFORM_RULES = [
    ...
    (("小红书", "xiaohongshu", "xhs"), "references/src-rules/xhs.md",
     "XHSSRC: 奖励=危害等级×子级W×业务价值B(主站核心功能=关键业务); SSRF 官方靶标 10.11.23.35:5555 "
     "(完整回显=高危/无回显=中危/无回显bind=低危); 风控异常线索独立赛道(账号风控+反爬); 60天同类型只收前3; "
     "质量报告奖+20%; Nday已知不收; 内部已知/专项治理期间不收"),
]
